...
struct thread
{
	...
	struct semaphore wakeup; 		/**< Semaphore for wake up. */
	struct list_elem block_elem; 	/**< List element for block list. */
	...
	struct lock* donee_lock;	/**< Lock that the thread is waiting for. */
